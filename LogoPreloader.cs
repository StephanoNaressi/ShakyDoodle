...
namespace ShakyDoodle
{
    ...
    public static class LogoStrokes
    {
        public static List<Stroke> Get()
        {
            ...
            var stroke = new Stroke((ColorType)0, new Point(37.067171891147154, 10.949689000866101), (SizeType)0, 1, PenLineCap.Square, 0.01f, true);
            ...
            var stroke1 = new Stroke((ColorType)0, new Point(52.499483293144976, 36.7996220770018), (SizeType)0, 1, PenLineCap.Square, 0.03f, true);
            ...
            var stroke2 = new Stroke((ColorType)0, new Point(53.160868067516276, 37.479883473742234), (SizeType)0, 1, PenLineCap.Square, 0f, true);
            ...
            var stroke3 = new Stroke((ColorType)0, new Point(78.07302790217022, 27.275962522636007), (SizeType)0, 1, PenLineCap.Square, 0.01f, true);
            ...
            var stroke4 = new Stroke((ColorType)0, new Point(111.5831898036513, 24.895047634044545), (SizeType)0, 1, PenLineCap.Square, 0.02f, true);
            ...
            var stroke5 = new Stroke((ColorType)0, new Point(19.43024457457807, 91.33391071569167), (SizeType)0, 1, PenLineCap.Square, 0.01f, true);
            ...
            var stroke6 = new Stroke((ColorType)0, new Point(57.570099896658576, 73.53373750098422), (SizeType)0, 1, PenLineCap.Square, 0.01f, true);
            ...
            var stroke7 = new Stroke((ColorType)0, new Point(91.3007233895969, 70.24580741673878), (SizeType)0, 1, PenLineCap.Square, 0.02f, true);
            ...
            var stroke8 = new Stroke((ColorType)0, new Point(105.63072683430937, 84.19116604991734), (SizeType)0, 1, PenLineCap.Square, 0.02f, true);
            ...
            var stroke9 = new Stroke((ColorType)0, new Point(116.21288322425085, 79.54271317219116), (SizeType)0, 1, PenLineCap.Square, 0.02f, true);
            ...
            var stroke10 = new Stroke(ColorType.Third, new Point(156.11643127798834, 85.09818124557125), (SizeType)0, 1, PenLineCap.Round, 0.01f, true);
